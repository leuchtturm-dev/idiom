...
Terminals mod is_op not_op sample operand tilde or_op and_op range_op
...
condition         ->  and_condition or_op condition : or_function('$1', '$3').
condition         ->  and_condition : '$1'.

and_condition     ->  relation and_op and_condition : and_function('$1', '$3').
